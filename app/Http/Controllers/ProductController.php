...
//$products=Products::where('subcategory_id',$id)->paginate(4);
//$allsubproduct=CatProject::where('category_id',$id)->paginate(8);

        return view('Product.product')->withcat($category)->withsub($subcategory)->withproduct($allsubproduct);
